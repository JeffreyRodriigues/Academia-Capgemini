...
public class LinkedListCarros {
	...
	public static void main(String[] args) {
		...
		cars.addFirst("MAZDA");
		System.out.println(cars);
		System.out.println("(addFirst) - Incluindo Mazda no início");
		System.out.println("");
		...
		System.out.println("(get(position)) - Mostrando carro da terceira posição");
		System.out.println("");
		...
		System.out.println("(getLast) - Mostrando último carro da lista");
		System.out.println("");
		
		cars.removeLast();
		System.out.println(cars);
		System.out.println("(removeLast) - Removendo último carro da lista 'BUGATTI'");
		System.out.println("");
